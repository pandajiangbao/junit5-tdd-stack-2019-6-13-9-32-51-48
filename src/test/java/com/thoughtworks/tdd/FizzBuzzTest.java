...
public class FizzBuzzTest {
    ...
    @Test
    public void return_FizzBuzz_when_input_21(){
        //Given
        int num=21;
        FizzBuzz fizzBuzz = new FizzBuzz();
        //When
        String convert = fizzBuzz.convert(num);
        //Then
        Assertions.assertEquals("FizzWhizz",convert);
    }
    @Test
    public void return_BuzzWhizz_when_input_35(){
        //Given
        int num=35;
        FizzBuzz fizzBuzz = new FizzBuzz();
        //When
        String convert = fizzBuzz.convert(num);
        //Then
        Assertions.assertEquals("BuzzWhizz",convert);
    }
    @Test
    public void return_FizzBuzzWhizz_when_input_105(){
        //Given
        int num=105;
        FizzBuzz fizzBuzz = new FizzBuzz();
        //When
        String convert = fizzBuzz.convert(num);
        //Then
        Assertions.assertEquals("FizzBuzzWhizz",convert);
    }
}
